 ...
 * </ul>
 * <p>
 * {@code StringUtils} handles {@code null} input Strings quietly. That is to say that a {@code null} input will return
 * {@code null}. Where a {@code boolean} or {@code int} is being returned details vary by method.
 * </p>
 * <p>
 * A side effect of the {@code null} handling is that a {@code NullPointerException} should be considered a bug in
 * {@code StringUtils}.
 * </p>
 * <p>
 * Methods in this class give sample code to explain their operation. The symbol {@code *} is used to indicate any input
 * including {@code null}.
 * </p>
 * <p>
 * #ThreadSafe#
...
public class StringUtils {
     ...
     * </p>
     * <p>
     * This method will use the first available implementation of: Java 6's {@link java.text.Normalizer}, Java
     * 1.3&ndash;1.5's {@code sun.text.Normalizer}
     * </p>
     * 
     * <pre>
        ...
        try {
            ...
            if (InitStripAccents.java6NormalizeMethod != null) {
                ...
                throw new UnsupportedOperationException("The stripAccents(CharSequence) method requires at least"
                        + " Java6, but got: " + InitStripAccents.java6Exception + "; or a Sun JVM: "
    ...
    /**
     * Use {@code java.text.Normalizer#normalize(CharSequence, Normalizer.Form)} (but be careful, this class exists in
     * Java 1.3, with an entirely different meaning!)
     * 
     ...
     */
    private static String removeAccentsJava6(CharSequence text) throws IllegalAccessException,
        ...
        String result;
        result = (String) InitStripAccents.java6NormalizeMethod.invoke(null, new Object[] { text,
                InitStripAccents.java6NormalizerFormNFD });
