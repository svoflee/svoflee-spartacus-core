...
public abstract class AnnotationUtils {
     ...
     * {@code clazz} itself) which declares an annotation for the
     * specified {@code annotationType}, or {@code null} if not found. If the supplied {@code clazz} is {@code null},
     ...
     *            or {@code null}
     * @return the first {@link Class} in the inheritance hierarchy of the specified {@code clazz} which declares an
     *         annotation for the specified {@code annotationType}, or {@code null} if not found
     ...
     * declared locally on the supplied {@code clazz}. The supplied {@link Class} may represent any type.
     * <p>
     * Note: This method does <strong>not</strong> determine if the annotation is
     * {@linkplain java.lang.annotation.Inherited inherited}. For greater clarity regarding inherited annotations,
     * consider using {@link #isAnnotationInherited(Class, Class)} instead.
     * 
     * @param annotationType the Class object corresponding to the annotation type
     * @param clazz the Class object corresponding to the class on which to check for the annotation
     * @return {@code true} if an annotation for the specified {@code annotationType} is declared locally on the
     *         supplied {@code clazz}
     * @see Class#getDeclaredAnnotations()
     ...
     * on the supplied {@code clazz} and is {@linkplain java.lang.annotation.Inherited inherited} (i.e., not declared
     * locally for the class).
     * <p>
     ...
     * {@linkplain java.lang.annotation.Inherited Javadoc} for the {@code @Inherited} meta-annotation for further
     ...
     * as-is.
     * <p>
     * Note: As of Spring 3.1.1, the returned map is actually an {@link AnnotationAttributes} instance, however the Map
     * signature of this method has been preserved for binary compatibility.
     * 
    ...
    /**
     * Retrieve the given annotation's attributes as an {@link AnnotationAttributes} map structure. Implemented in
     * Spring 3.1.1 to provide fully recursive annotation
     ...
     *            compatibility with {@link org.springframework.core.type.AnnotationMetadata} or to
     *            preserve them as Class references
     * @param nestedAnnotationsAsMap whether to turn nested Annotation instances into {@link AnnotationAttributes} maps
     *            (for compatibility with {@link org.springframework.core.type.AnnotationMetadata} or to preserve them
     *            as
